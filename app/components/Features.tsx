        ...
        <div className="py-12 md:py-20">
          ...
          >
            ...
            >
              ...
              <h4 className="h4 mb-2">Book Online Migration Agent</h4>
              <p className="text-lg text-gray-400 text-center">
                You can book the registered migration from this page, with the
                comfort of sitting at your home or you can visit the office.
                <span>$50/hr</span>
              </p>
            </div>
            ...
            >
              ...
              <h4 className="h4 mb-2">Post</h4>
              <p className="text-lg text-gray-400 text-center">
                create a post about any question you have, including your
                migration status or future planning. Get the views from the
                expert.
              </p>
            </div>
            ...
            >
              ...
              <h4 className="h4 mb-2">Add Case</h4>
              <p className="text-lg text-gray-400 text-center">
                Add application details to help each other. Students can benefit
                with looking other cases.
              </p>
            </div>
