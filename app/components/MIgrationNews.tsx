  ...
  return (
    <div className="bg-white-100">
      <div className="container my-24 mx-auto md:px-6">
        <hr />
        <section className="mb-32 text-center md:text-left mt-5">
          ...
          <div className="mb-6 flex flex-wrap">
            ...
            <div className="mb-6 mr-auto w-full shrink-0 grow-0 basis-auto px-3 md:mb-0 md:w-9/12 xl:w-7/12">
              <h5 className="mb-3 text-lg font-bold">
                Government is decreasing the migration quota
              </h5>
          ...
          <div className="mb-6 flex flex-wrap">
            ...
            <div className="mb-6 mr-auto w-full shrink-0 grow-0 basis-auto px-3 md:mb-0 md:w-9/12 xl:w-7/12">
              <h5 className="mb-3 text-lg font-bold">
                NSW has realesed the occupation list for 2024
              </h5>
